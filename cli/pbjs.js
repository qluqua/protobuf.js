...
exports.main = function main(args, callback) {
    ...
    var argv = minimist(args, {
        ...
        boolean: [ "create", "encode", "decode", "verify", "convert", "delimited", "beautify", "comments", "service", "es6", "sparse", "keep-case", "alternate-comment-mode", "force-long", "force-number", "force-enum-string", "force-message" ],
        default: {
            target: "json",
            create: true,
            encode: true,
    ...
    if (!files.length) {
        ...
        if (callback)
            ...
            process.stderr.write([
                ...
                "",
                "",
                "  --alternate-comment-mode Saves your non js-style comments in compiled code.",
                "",
